...
## 分岐
- 変数 a, b にそれぞれ 8, 2 を代入し, 割り切れるかを判定しよう
- 変数nに数値 6 を代入し偶数か奇数かを判定しよう(n の値を 7 や 100 といった好きな数値に変更してみよう)
- 変数a, b にそれぞれ 8, 16 の値を代入し, 大きい方の値を表示しよう
- 前回のサンプルを修正して, 小さい方の値を表示しよう
- 変数 a, b, c にそれぞれ 8, 32, 16 を代入し, 一番大きい値を表示しよう
- 条件式(if)を試してみよう
